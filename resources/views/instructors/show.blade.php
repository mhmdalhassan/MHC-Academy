...
<div class="card">
    ...
    <div class="card-body">
        ...
        <p><strong>Graduates:</strong> {{ $instructor->graduates }}</p>
        ...
        <a href="{{ route('instructors.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
    </div>
</div>
@endsection --}}
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <p><strong>Title:</strong> {{ $instructor->title }}</p>
        <p><strong>Description:</strong> {{ $instructor->description }}</p>
        {{-- <p><strong>Graduates:</strong> {{ $instructor->students_graduated }}</p> --}}
        <p><strong>Rating:</strong> {{ $instructor->rating }} ⭐</p>
        <p>
            <strong>Image:</strong><br>
            @if($instructor->image)
